...
# Trim reads (after 1 and 2)
 		Trimming.txt
 		Trim_Galore_array.sh
		Trimmomatic_array.sh


# Prepare your resources: find your genome, find your annotation (if using), choose your aligner, update your alignment software, and index your genome (before or after 1)
 		Downloading_and_obtaining_sequence.txt
		Index_genome.txt
 		STAR_index.sh
