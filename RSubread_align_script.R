...
align(index="/home/jlrifkin/Analyses/Transcriptome/RSubread/Ipomoea_index",readfile1=reads,input_format="gzFASTQ",output_format="BAM",nthreads=4, output_file = paste(str(getwd),"RSubread_Alignment/",samplenames,".subread.bam",sep=""), useAnnotation = TRUE, annot.ext="/nfs/turbo/rsbaucom/lab/IP_genome_COGE/Ipomoea_purpurea_annos1-cds0-id_typename-nu1-upa1-add_chr0.gid58735.gtf", isGTF = TRUE)
